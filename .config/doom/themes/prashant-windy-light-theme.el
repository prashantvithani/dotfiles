;;; prashant-windy-light-theme.el --- based on Tailwind colors -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup prashant-windy-light-theme nil
  "Options for the `prashant-windy-light' theme."
  :group 'doom-themes)

(defcustom prashant-windy-light-brighter nil
  "If non-nil, more vivid colors will be used."
  :group 'prashant-windy-light-theme
  :type 'boolean)

(defcustom prashant-windy-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme prashant-windy-light
  ...
  (
   ...
   (modeline-fg-alt          (doom-blend
                              fg bg-alt
                              (if prashant-windy-light-brighter 0.6 0.5)))
   (modeline-bg              (if prashant-windy-light-brighter
                                 bg-alt
                               (doom-darken bg 0.05)))
   ...
   (-modeline-pad
    (when prashant-windy-light-padded-modeline
      (if (integerp prashant-windy-light-padded-modeline) prashant-windy-light-padded-modeline 4))))
  ...
  (
   ...
   (mode-line-inactive
    ...
    :underline nil)
   (mode-line-emphasis
    :foreground (if prashant-windy-light-brighter base8 builtin))
   (mode-line-buffer-id :foreground dsky :weight 'normal)
   (mode-line-highlight
    :background modeline-bg
    :foreground fg
    :box nil
   ...
   (centaur-tabs-unselected :background base2 :foreground base5)
   (centaur-tabs-default :background base2 :foreground base5)
   (centaur-tabs-unselected-modified :background base2 :foreground red)
   (centaur-tabs-modified-marker-unselected :background base2 :foreground base5)
   (centaur-tabs-close-unselected :background base2 :foreground base5)
   (centaur-tabs-close-mouse-face :background nil :foreground red)
        ;;;; company
   (company-tooltip :background base2 :foreground fg)
   (company-tooltip-common :foreground amber :weight 'bold)
   (company-tooltip-quick-access :foreground violet)
   (company-tooltip-scrollbar-thumb :background red)
   (company-tooltip-scrollbar-track :background base2)
   (company-tooltip-search :background amber :foreground bg :distant-foreground fg)
   (company-tooltip-selection :background (doom-blend bg blue 0.3) :foreground fg :weight 'bold)
   (company-tooltip-mouse :background base2 :foreground bg :distant-foreground fg)
   ...
   (company-preview-common :foreground amber :weight 'bold)
   ...
   (doom-modeline-warning :foreground amber :weight 'bold)
   ...
   (flycheck-info    :underline `(:style dots :color ,cyan))
   (flycheck-fringe-error :foreground error :inherit 'bold)
   (flycheck-fringe-warning :foreground warning :inherit 'bold)
   (flycheck-fringe-info :foreground cyan :inherit 'bold)
        ;;;; git-gutter
   (git-gutter:added :foreground vc-added :background bg-alt)
   (git-gutter:modified :foreground vc-modified :background bg-alt)
   (git-gutter:deleted :foreground vc-deleted :background bg-alt)
        ;;;; gnus
   ...
   ((outline-1 &override)
    :foreground (doom-blend fg blue    (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-2 &override)
    :foreground (doom-blend fg purple  (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-3 &override)
    :foreground (doom-blend fg rose    (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-4 &override)
    :foreground (doom-blend fg orange  (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-5 &override)
    :foreground (doom-blend fg lime    (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-6 &override)
    :foreground (doom-blend fg cyan    (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-7 &override)
    :foreground (doom-blend fg indigo  (if prashant-windy-light-brighter 0.25 0.33)))
   ((outline-8 &override)
    :foreground (doom-blend fg fuchsia (if prashant-windy-light-brighter 0.25 0.33)))
        ;;;; org
   ...
   (ruler-mode-margins        :inherit 'ruler-mode-default :foreground white)
   (ruler-mode-pad            :inherit 'ruler-mode-default :background base4)
   ...
   ((wgrep-face &override) :background base1)
        ;;;; which-key
   (which-key-local-map-description-face :foreground amber)
...
;;; prashant-windy-light-theme.el ends here
