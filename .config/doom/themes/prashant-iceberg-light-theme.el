...
;;
(defgroup prashant-iceberg-light-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom prashant-iceberg-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-iceberg-light-theme
  :type 'boolean)

(defcustom prashant-iceberg-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-iceberg-light-theme
  :type 'boolean)

(defcustom prashant-iceberg-light-comment-bg prashant-iceberg-light-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'prashant-iceberg-light-theme
  :type 'boolean)

(defcustom prashant-iceberg-light-padded-modeline doom-themes-padded-modeline
...
(eval-and-compile
  (defcustom prashant-iceberg-light-region-highlight t
...
;;
(def-doom-theme prashant-iceberg-light
  ...
  ((bg         '("#E8E9EC" "#E8E9EC" nil))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if prashant-iceberg-light-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if prashant-iceberg-light-brighter-comments dark-cyan base5) 0.25))
   (constants      violet)
   (functions      blue)
   (keywords       magenta)
   (methods        cyan)
   ...
   (-modeline-bright prashant-iceberg-light-brighter-modeline)
   (-modeline-pad
    (when prashant-iceberg-light-padded-modeline
      (if (integerp prashant-iceberg-light-padded-modeline) prashant-iceberg-light-padded-modeline 4)))
...
;;; prashant-iceberg-light-theme.el ends here
