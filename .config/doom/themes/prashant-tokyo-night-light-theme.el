...
(defgroup prashant-tokyo-night-light-theme nil
  "Options for doom-themes."
  :group 'doom-themes)

(defcustom prashant-tokyo-night-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-tokyo-night-light-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-tokyo-night-light-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-light-comment-bg prashant-tokyo-night-light-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'prashant-tokyo-night-light-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-light-padded-modeline nil
...
(def-doom-theme prashant-tokyo-night-light
  ...
  ((bg         '("#e6e7ed" nil       nil            ))
   ...
   (-modeline-bright prashant-tokyo-night-light-brighter-modeline)
   (-modeline-pad
    (when prashant-tokyo-night-light-padded-modeline
      (if (integerp prashant-tokyo-night-light-padded-modeline) prashant-tokyo-night-light-padded-modeline 4)))
