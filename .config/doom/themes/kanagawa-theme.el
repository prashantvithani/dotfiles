...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (bg-alt     "#1D1C19" "#1D1C19")
  (fg-alt     "#C8C093" "#C8C093")
  ...
  (yellow     carpYellow)
  (blue       springBlue)
  (dark-blue  crystalBlue)
  (magenta    oniViolet)
  (violet     springViolet2)
  (cyan       lightBlue)
  (dark-cyan  dragonBlue)
  (vc-modified    orange)
  (vc-added       green)
  (vc-deleted     red)
  )
  ...
  (flycheck-fringe-warning                       (:foreground carpYellow))
  ...
  (treemacs-git-added-face                       (:foreground carpYellow))
  ...
  (evil-ex-substitute-replacement                (:foreground carpYellow :strike-through nil :inherit 'evil-ex-substitute-matches))
  ...
  ;; (vc-added       (:foreground autumnGreen))
  ;; (vc-deleted     (:foreground waveRed))
  ;; (vc-modified    (:foreground springBlue))
  ...
  (git-gutter-fr:added                              (:foreground autumnGreen))
  (git-gutter-fr:deleted                            (:foreground waveRed))
  (git-gutter-fr:modified                           (:foreground springBlue))

  (diff-hl-change                                (:foreground springBlue))
  (diff-hl-delete                                (:foreground peachRed))
  (diff-hl-insert                                (:foreground autumnGreen))

  (diff-indicator-changed                        (:foreground springBlue))
  (diff-indicator-removed                        (:foreground peachRed))
  (diff-indicator-added                          (:foreground autumnGreen))
  ...
  (diff-hl-margin-insert                         (:foreground autumnGreen :background winterGreen))
  ...
  ;; (magit-diff-added             (:foreground autumnGreen  :extend t))
  ;; (magit-diff-added-highlight   (:foreground vc-added :weight 'bold :extend t))
  ;; (magit-diff-base              (:foreground waveRed :extend t))
  ;; (magit-diff-base-highlight    (:foreground orange :weight 'bold :extend t))
