...
(defgroup prashant-tokyo-night-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom prashant-tokyo-night-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-tokyo-night-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-tokyo-night-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-comment-bg prashant-tokyo-night-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'prashant-tokyo-night-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-padded-modeline nil
...
(def-doom-theme prashant-tokyo-night
  ...
  ((bg         '("#1a1b26" nil       nil            ))
   ...
   (selection      base0)
   (builtin        red)
   (comments       (if prashant-tokyo-night-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if prashant-tokyo-night-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
   ...
   (-modeline-bright prashant-tokyo-night-brighter-modeline)
   (-modeline-pad
    (when prashant-tokyo-night-padded-modeline
      (if (integerp prashant-tokyo-night-padded-modeline) prashant-tokyo-night-padded-modeline 4)))
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if prashant-tokyo-night-comment-bg (doom-lighten bg 0.05) 'unspecified)
    :slant 'italic)
   (font-lock-doc-face
...
;;; prashant-tokyo-night-theme.el ends here
