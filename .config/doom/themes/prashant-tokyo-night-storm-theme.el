...
(defgroup prashant-tokyo-night-storm-theme nil
  "Options for doom-themes."
  :group 'doom-themes)

(defcustom prashant-tokyo-night-storm-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-tokyo-night-storm-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-storm-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-tokyo-night-storm-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-storm-comment-bg prashant-tokyo-night-storm-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'prashant-tokyo-night-storm-theme
  :type 'boolean)

(defcustom prashant-tokyo-night-storm-padded-modeline nil
...
(def-doom-theme prashant-tokyo-night-storm
  ...
  ((bg         '("#24283b" nil       nil            ))
   ...
   (selection      base0)
   (builtin        red)
   (comments       (if prashant-tokyo-night-storm-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if prashant-tokyo-night-storm-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
   ...
   (-modeline-bright prashant-tokyo-night-storm-brighter-modeline)
   (-modeline-pad
    (when prashant-tokyo-night-storm-padded-modeline
      (if (integerp prashant-tokyo-night-storm-padded-modeline) prashant-tokyo-night-storm-padded-modeline 4)))
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if prashant-tokyo-night-storm-comment-bg (doom-lighten bg 0.05) 'unspecified)
    :slant 'italic)
   (font-lock-doc-face
...
;;; prashant-tokyo-night-storm-theme.el ends here
