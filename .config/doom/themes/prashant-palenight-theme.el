...
(defgroup prashant-palenight-theme nil
  "Options for the `prashant-palenight' theme."
  :group 'doom-themes)

(defcustom prashant-palenight-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'prashant-palenight-theme
...
(def-doom-theme prashant-palenight
  ...
  ((bg         '("#292D3E" nil       nil))
   ...
   (vertical-bar   base2)
   (selection      base4)
   (builtin        (doom-lighten dark-cyan 0.2))
   (comments       base5)
   ...
   (type           magenta)
   (strings        green)
   (variables      (doom-lighten yellow 0.3))
   ...
   (-modeline-pad
    (when prashant-palenight-padded-modeline
      (if (integerp prashant-palenight-padded-modeline) prashant-palenight-padded-modeline 4))))
...
;;; prashant-palenight-theme.el ends here
