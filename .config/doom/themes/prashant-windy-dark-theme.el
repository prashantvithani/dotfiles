;;; prashant-windy-dark-theme.el --- based on Tailwind colors -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup prashant-windy-dark-theme nil
  "Options for the `prashant-windy-dark' theme."
  :group 'doom-themes)

(defcustom prashant-windy-dark-brighter nil
  "If non-nil, more vivid colors will be used."
  :group 'prashant-windy-dark-theme
  :type 'boolean)

(defcustom prashant-windy-dark-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme prashant-windy-dark
    "A dark theme inspired by Tailwind."
  :family 'prashant-windy
  ...
  (
   ...
   (selection      grey)
   (builtin        sky)
   (comments       (if prashant-windy-dark-brighter (doom-blend purple base3 0.7) base3))
   ...
   (operators      pink)
   (type           cyan)
   (strings        (doom-lighten emerald 0.3))
   (variables      (doom-lighten purple 0.5))
   (numbers        orange)
   ...
   (modeline-fg-alt          (doom-blend
                              fg bg-alt
                              (if prashant-windy-dark-brighter 0.6 0.5)))
   (modeline-bg              (if prashant-windy-dark-brighter
                                 bg-alt
   ...
   (-modeline-pad
    (when prashant-windy-dark-padded-modeline
      (if (integerp prashant-windy-dark-padded-modeline) prashant-windy-dark-padded-modeline 4))))

    ;;;; Base theme face overrides
  (
        ;;;; Emacs Lisp faces
   ((cursor &override) :background bgreen)
   (help-key-binding
    :inherit 'fixed-pitch
    :background base1
    :foreground indigo
   ...
   (mode-line-inactive
    ...
    :underline nil)
   (mode-line-emphasis
    :foreground (if prashant-windy-dark-brighter base8 builtin))
   (mode-line-buffer-id :foreground bsky :weight 'normal)
   (mode-line-highlight
    :background modeline-bg
    :foreground fg
    :box nil
   ...
   (trailing-whitespace :background (doom-blend bg red 0.4))
   (tab-line :inherit 'mode-line)
   (tool-bar :inherit 'mode-line)

        ;;;; font-lock-* faces
   ((font-lock-comment-face &override) :slant 'italic)
   ((font-lock-comment-delimiter-face &override) :slant 'italic)
   ((font-lock-doc-face &override) :slant 'italic)
   ((font-lock-keyword-face &override) :weight 'bold :slant 'italic)
   ...
   (centaur-tabs-modified-marker-selected :background bg :foreground amber)
   (centaur-tabs-close-selected :inherit 'centaur-tabs-selected)
   (centaur-tabs-unselected :background base1 :foreground base4)
   (centaur-tabs-default :background base1 :foreground base4)
   (centaur-tabs-unselected-modified :background base1 :foreground red)
   (centaur-tabs-modified-marker-unselected :background base1 :foreground base4)
   (centaur-tabs-close-unselected :background base1 :foreground base4)
   ...
   (company-tooltip-scrollbar-thumb :background dred)
   (company-tooltip-scrollbar-track :background base1)
   (company-tooltip-search :background amber :foreground bg :distant-foreground fg)
   (company-tooltip-selection :background (doom-blend bg blue 0.4) :foreground fg :weight 'bold)
   (company-tooltip-mouse :background base1 :foreground bg :distant-foreground fg)
   (company-tooltip-annotation :foreground rose :distant-foreground base1)
   (company-scrollbar-bg :inherit 'tooltip)
   (company-scrollbar-fg :background red)
   (company-preview :foreground amber)
   (company-preview-common :foreground yellow :weight 'bold)
   ...
   (dired-set-id :foreground orange)
        ;;;; dashboard
   (dashboard-heading :foreground violet :weight 'bold)
   (dashboard-items-face :foreground fg)
   (dashboard-banner-logo-title :weight 'bold :height 200)
   (dashboard-no-items-face :foreground base4)
        ;;; Doom Dashboard
   ...
   (doom-modeline-panel :inherit 'bold :background orange :foreground base1)
   (doom-modeline-info :weight 'bold :foreground green)
   ...
   (flycheck-warning :underline `(:style dashes :color ,warning))
   (flycheck-info    :underline `(:style dots :color ,teal))
   (flycheck-fringe-error :foreground error :inherit 'bold)
   (flycheck-fringe-warning :foreground warning :inherit 'bold)
   (flycheck-fringe-info :foreground teal :inherit 'bold)
        ;;;; git-gutter
   (git-gutter:added :foreground vc-added :background base0)
   (git-gutter:modified :foreground vc-modified :background base0)
   (git-gutter:deleted :foreground vc-deleted :background base0)
        ;;;; gnus
   ...
   (highlight-indent-guides-stack-odd-face :foreground base2)
   (highlight-indent-guides-stack-even-face :foreground base1)
   (highlight-indent-guides-even-face :foreground base1)
   (highlight-indent-guides-odd-face :foreground base2)
   ...
   (magit-diff-added-highlight   :foreground vc-added                      :background (doom-blend vc-added bg 0.15) :extend t)
   (magit-diff-base              :foreground (doom-darken vc-modified 0.2) :background (doom-blend vc-modified bg 0.1) :extend t)
   (magit-diff-base-highlight    :foreground vc-modified                   :background (doom-blend vc-modified bg 0.15) :extend t)
   ...
   (magit-diff-removed-highlight :foreground vc-deleted                   :background (doom-blend vc-deleted bg 0.15) :extend t)
   ...
   (markdown-header-face-1         :inherit 'outline-1 :height 1.3 :weight 'bold)
   (markdown-header-face-2         :inherit 'outline-2 :height 1.15 :weight 'bold)
   (markdown-header-face-3         :inherit 'outline-3 :height 1.05)
   ...
   ((outline-1 &override)
    :foreground (doom-blend fg blue    (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-2 &override)
    :foreground (doom-blend fg purple  (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-3 &override)
    :foreground (doom-blend fg rose    (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-4 &override)
    :foreground (doom-blend fg orange  (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-5 &override)
    :foreground (doom-blend fg lime    (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-6 &override)
    :foreground (doom-blend fg cyan    (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-7 &override)
    :foreground (doom-blend fg indigo  (if prashant-windy-dark-brighter 0.25 0.33)))
   ((outline-8 &override)
   ...
   ((paren-face-no-match &inherit paren-face-mismatch))
        ;;;; show-paren
   (show-paren-match :background teal :foreground bg :weight 'bold)
   (show-paren-mismatch :background red :foreground fg-alt)
        ;;;; popup
   ...
   (treemacs-directory-face :foreground bblue)
   (treemacs-directory-collapsed-face :foreground bsky)
   ...
   (treemacs-git-modified-face :foreground bgreen)
        ;;;; tty-menu
   ...
   (tty-menu-selected-face :background dblue  :foreground base8)
        ;;;; vertico
   (vertico-group-title :foreground sky :weight 'bold)
   (vertico-group-separator :foreground sky :strike-through t)
   (vertico-posframe-border :background base2)
...
;;; prashant-windy-dark-theme.el ends here
