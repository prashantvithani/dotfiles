;;; prashant-kanagawa-lotus-theme.el --- inspired by rebelot/kanagawa.nvim (lotus) -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup prashant-kanagawa-lotus-theme nil
  "Options for the `prashant-kanagawa-lotus' theme."
  :group 'doom-themes)

(defcustom prashant-kanagawa-lotus-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-kanagawa-lotus-theme
  :type 'boolean)

(defcustom prashant-kanagawa-lotus-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-kanagawa-lotus-theme
  :type 'boolean)

(defcustom prashant-kanagawa-lotus-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'prashant-kanagawa-lotus-theme
  :type '(choice integer boolean))

(defcustom prashant-kanagawa-lotus-match-org-blocks nil
...
(def-doom-theme prashant-kanagawa-lotus
  ...
  ((bg         '("#f2ecbc" "#ffffaf" "white"))
   ...
   (builtin        blue)
   (comments       (if prashant-kanagawa-lotus-brighter-comments dark-cyan lotus-gray3))
   (doc-comments   (if prashant-kanagawa-lotus-brighter-comments dark-cyan fg-alt))
   (constants      orange)
   (functions      dark-blue)
   (keywords       magenta)
   (methods        cyan)
   ...
   (modeline-bg              (if prashant-kanagawa-lotus-brighter-modeline
                                 (doom-lighten dark-blue 0.4)
                               base1))
   (modeline-bg-alt          (if prashant-kanagawa-lotus-brighter-modeline
   ...
   (-modeline-pad
    (when prashant-kanagawa-lotus-padded-modeline
      (if (integerp prashant-kanagawa-lotus-padded-modeline)
          prashant-kanagawa-lotus-padded-modeline
        4))))
  ...
  (
   ...
   (mode-line-emphasis :foreground (if prashant-kanagawa-lotus-brighter-modeline base8 highlight))
...
;;;; doom-modeline
   (doom-modeline-bar :background (if prashant-kanagawa-lotus-brighter-modeline modeline-bg violet) :bold t)
...
;;;; org-mode
   ...
   (org-block-begin-line
    :background (if prashant-kanagawa-lotus-match-org-blocks base0 lotus-blue2)
    :foreground (if prashant-kanagawa-lotus-match-org-blocks base5 dark-blue))
   (org-block-end-line
    :background (if prashant-kanagawa-lotus-match-org-blocks base0 lotus-red4)
    :foreground (if prashant-kanagawa-lotus-match-org-blocks base5 red))
...
;;; prashant-kanagawa-lotus-theme.el ends here
