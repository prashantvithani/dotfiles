;;; prashant-kanagawa-wave-theme.el --- inspired by rebelot/kanagawa.nvim (wave) -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup prashant-kanagawa-wave-theme nil
  "Options for the `prashant-kanagawa-wave' theme."
  :group 'doom-themes)

(defcustom prashant-kanagawa-wave-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-kanagawa-wave-theme
  :type 'boolean)

(defcustom prashant-kanagawa-wave-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-kanagawa-wave-theme
  :type 'boolean)

(defcustom prashant-kanagawa-wave-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'prashant-kanagawa-wave-theme
  :type '(choice integer boolean))

(defcustom prashant-kanagawa-wave-red-cursor nil
  "If non-nil, cursor will be red."
  :group 'prashant-kanagawa-wave-theme
  :type 'boolean)

(defcustom prashant-kanagawa-wave-match-org-blocks nil
...
(def-doom-theme prashant-kanagawa-wave
  ...
  ((bg         '("#1F1F28" "#1c1c1c" "black"))
   ...
   (builtin        blue)
   (comments       (if prashant-kanagawa-wave-brighter-comments wave-aqua-1 base6))
   (doc-comments   (if prashant-kanagawa-wave-brighter-comments wave-aqua-1 comet))
   (constants      orange)
   (functions      dark-blue)
   (keywords       magenta)
   (methods        cyan)
   ...
   (modeline-bg              (if prashant-kanagawa-wave-brighter-modeline
                                 (doom-darken dark-blue 0.45)
                               base0))
   (modeline-bg-alt          (if prashant-kanagawa-wave-brighter-modeline
   ...
   (-modeline-pad
    (when prashant-kanagawa-wave-padded-modeline
      (if (integerp prashant-kanagawa-wave-padded-modeline)
          prashant-kanagawa-wave-padded-modeline
        4))))
  ...
  (
   ...
   (cursor :background (if prashant-kanagawa-wave-red-cursor red blue) :foreground base0)
   ...
   ((font-lock-comment-face &override) :foreground comments :italic t
    :background (if prashant-kanagawa-wave-brighter-comments (doom-lighten bg 0.05)))
   ...
   (mode-line-emphasis :foreground (if prashant-kanagawa-wave-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if prashant-kanagawa-wave-brighter-modeline modeline-bg spring-violet-1) :bold t)
   ...
   (org-block-begin-line
    :background (if prashant-kanagawa-wave-match-org-blocks base0 winter-blue)
    :foreground (if prashant-kanagawa-wave-match-org-blocks base5 blue))
   (org-block-end-line
    :background (if prashant-kanagawa-wave-match-org-blocks base0 winter-red)
    :foreground (if prashant-kanagawa-wave-match-org-blocks base5 peach-red))
...
;;; prashant-kanagawa-wave-theme.el ends here
