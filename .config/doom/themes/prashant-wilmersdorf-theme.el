...
(defgroup prashant-wilmersdorf-theme nil
  "Options for the `prashant-wilmersdorf' theme."
  :group 'doom-themes)

(defcustom prashant-wilmersdorf-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'prashant-wilmersdorf-theme
...
(def-doom-theme prashant-wilmersdorf
  ...
  ((bg         '("#282b33" "#282b33" nil            ))
   ...
   (orange     '("#e1c2fe" "#e1c2fe" "brightred"    ))
   ...
   (-modeline-pad
    (when prashant-wilmersdorf-padded-modeline
      (if (integerp prashant-wilmersdorf-padded-modeline) prashant-wilmersdorf-padded-modeline 4)))
...
;;; prashant-wilmersdorf-theme.el ends here
