...
;;
(defgroup prashant-iceberg-dark-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom prashant-iceberg-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'prashant-iceberg-dark-theme
  :type 'boolean)

(defcustom prashant-iceberg-dark-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'prashant-iceberg-dark-theme
  :type 'boolean)

(defcustom prashant-iceberg-dark-comment-bg prashant-iceberg-dark-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'prashant-iceberg-dark-theme
  :type 'boolean)

(defcustom prashant-iceberg-dark-padded-modeline doom-themes-padded-modeline
...
(eval-and-compile
  (defcustom prashant-iceberg-dark-region-highlight t
...
;;
(def-doom-theme prashant-iceberg-dark
  ...
  ((bg-alt     '("#161821" nil       nil))
   ...
   (-modeline-bright prashant-iceberg-dark-brighter-modeline)
   (-modeline-pad
    (when prashant-iceberg-dark-padded-modeline
      (if (integerp prashant-iceberg-dark-padded-modeline) prashant-iceberg-dark-padded-modeline 4)))

   (region-fg
    (when (memq prashant-iceberg-dark-region-highlight '(frost snowstorm))
      base0))
...
;;; prashant-iceberg-dark-theme.el ends here
